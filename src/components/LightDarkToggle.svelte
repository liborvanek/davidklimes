...
<button
  on:click={toggle}
  class="flex items-center justify-center w-10 h-10 bg-gray-100 dark:bg-dark-gray-700 rounded-full dark:text-gray-500 hover-hover:hover:text-amber-400 text-dark-gray-400 focus:outline-none focus:ring-4 focus:ring-blue-400 {classes}">
  {#if darkMode}
    <svg
      class="w-6 h-6"
      fill="none"
