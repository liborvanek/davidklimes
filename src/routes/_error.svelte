...
<PageTransition>
  <section
    ...
    {:else}
      <h1 class="mt-1 mb-4 text-6xl text-gray-500 dark:text-dark-gray-400 font-bold">{status}</h1>
      <h2 class="text-3xl">
        {status === 404 ? 'Stránka nebyla nalezena' : 'Bohužel, stránku se nepodařilo načíst'}
      </h2>
    {/if}
  </section>
</PageTransition>
